...
export const ENV_TO_API: Record<API_ENV, string | null> = {
	...
	[API_ENV.local]: process.env.NEXT_PUBLIC_API_ENDPOINT_LOCAL_FULLNODE || '',
	[API_ENV.devNet]: process.env.NEXT_PUBLIC_API_ENDPOINT_DEV_NET_FULLNODE || 'https://fullnode.devnet.sui.io:443',
	[API_ENV.testNet]: process.env.NEXT_PUBLIC_API_ENDPOINT_TEST_NET_FULLNODE || '',
	[API_ENV.mainnet]: process.env.NEXT_PUBLIC_API_ENDPOINT_MAINNET_FULLNODE || '',
};